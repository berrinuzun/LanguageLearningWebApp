...
@Controller
@RequestMapping("/admin-page/courses")
public class ContentControllerAdmin {
	...
	public String getContentById(@PathVariable Long id, Model model) {
		...
		if (optionalContent.isPresent()) {
			...
			return "contentDetailsPageAdmin";
		} else {
			return "redirect:/admin-page/courses/contents/{id}";
		}
	}
	...
	public String createContent(@RequestParam String contentTitle, @RequestParam String contentInformation,
	    ...
	    return "redirect:/admin-page/courses/" + courseId;
	}
	...
	public String getPracticeQuestionsByContent(@PathVariable Long id, Model model) {
		...
		if(contentOptional.isPresent()) {
			...
			return "practiceQuestionsPageAdmin";
			
		}else {
			return "redirect:/admin-page/courses/contents/" + contentId;
		}
