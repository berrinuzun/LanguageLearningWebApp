...
@Controller
@RequestMapping("/admin-page/courses/contents")
public class PracticeQuestionControllerAdmin {
	...
	public String createPracticeQuestionsForm(Model model) {
		...
		return "createPracticeQuestionsAdmin";
	...
	public String showUpdatePracticeQuestionForm(@PathVariable Long id, Model model) {
		...
		if(practiceQuestioOptional.isPresent()) {
			...
			return "updatePracticeQuestionFormAdmin";
