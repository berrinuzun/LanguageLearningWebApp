...
public class CourseControllerInstructor {
    ...
    public String showAddCourseForm() {
        return "addCoursePageInstructor";
    }

    @PostMapping("/add-course")
    public String addCourse(@RequestParam String courseTitle,
                            @RequestParam String contentInformation,
                            @RequestParam("image") MultipartFile file) throws IllegalAccessException, IOException, SerialException, SQLException {
        
        Blob blob = new SerialBlob(file.getBytes());

        File courseImage = new File();
        courseImage.setFileData(blob.getBytes(1, (int) blob.length()));
        courseImage.setType(file.getContentType());
        courseImage.setName(file.getOriginalFilename());

        Course course = new Course();
        course.setCourseTitle(courseTitle);
        course.setContentInformation(contentInformation);
    ...
    @PostMapping("/courses/delete-course/{id}")
    public String deleteCourse(@PathVariable Long id) {
    	...
    	if(courseOptional.isPresent()) {
    		Long ID = courseOptional.get().getId();
    ...
    public String showUpdateForm(@PathVariable Long id, Model model) {
    	...
    	if (courseOptional.isPresent()) {
            ...
            return "updateCoursePageInstructor";
    ...
    public String updateCourse(@PathVariable Long id,
        ...
        if (courseOptional.isPresent()) {
            ...
            course.setCourseTitle(courseTitle);
            course.setContentInformation(courseInformation);
            courseService.saveCourse(course);
        }
